...
ActiveRecord::Schema.define(version: 2020_08_19_102656) do
  ...
  create_table "rentings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["superpower_id"], name: "index_rentings_on_superpower_id"
  ...
  create_table "superpowers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category_id"], name: "index_superpowers_on_category_id"
  ...
  add_foreign_key "rentings", "superpowers"
  add_foreign_key "rentings", "users"
  add_foreign_key "superpowers", "categories"
